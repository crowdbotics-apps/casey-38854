"""
Django settings for casey_38854 project.
...
WSGI_APPLICATION = 'casey_38854.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "casey_38854 API",
    "DESCRIPTION": "API documentation for casey_38854 App",
    "VERSION": "v1",
}
